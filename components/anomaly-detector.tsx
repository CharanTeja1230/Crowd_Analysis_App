...
import { AlertCircle, BarChart4, Info } from "lucide-react"
...
export function AnomalyDetector({ location, anomalyCount }: AnomalyDetectorProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      // Generate random anomalies based on the count
    ...
    <Card className="w-full">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          ...
          <Badge>{anomalyCount} detected</Badge>
        </div>
