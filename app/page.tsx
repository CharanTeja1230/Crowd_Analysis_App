        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8">
          <div className="mx-auto max-w-7xl space-y-6">
            <div className="grid gap-6 md:grid-cols-3">
              <div className="md:col-span-2">
                <DensityDisplay
                  ...
                  density={locationData[currentLocation.toLowerCase()]?.currentDensity || 0}
                  trend={locationData[currentLocation.toLowerCase()]?.densityTrend || "stable"}
                  lastUpdated={locationData[currentLocation.toLowerCase()]?.lastUpdated || new Date().toISOString()}
                />
              </div>
              <div>
                <EnhancedSensorPanel
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <AnomalyDetector
                location={currentLocation}
                anomalyCount={locationData[currentLocation.toLowerCase()]?.anomalyCount || 0}
              />
